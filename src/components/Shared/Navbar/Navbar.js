...
import logo from '../../../images/eagle-22.PNG'
const Navbar = () => {
    ...
    return (
        <div className="" style={{border: '1px solid red', marginBottom:'6%'}}>
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ml-auto ">
                            ...
                            <li className="nav-item mr-4">
                                <Link className="nav-link" to="/shortOrderList"> Bookings </Link>
                            </li>
                            <li className="nav-item mr-4">
                            ...
                            <li className="nav-item mr-4">
                                <a className="nav-link" href="#"> {userLogged.name} </a>
                            </li>
                            <li className="nav-item mr-4">
                                {
                                    userLogged.success? 
