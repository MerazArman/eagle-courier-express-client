...
import imgCard1 from '../../../images/benar4.PNG';
import imgCard2 from '../../../images/bnenar-2.PNG';
import imgCard3 from '../../../images/benar1.PNG'
                ...
                {topServiceData.map(topService =>
                    <div className="col-md-4">
                        ...
                        <div class="card" data-aos="fade-up">
                            <img src={topService.img} class="card-img-top" alt="..." />
                            <div class="card-body">
                    ...
                    <button className=" btn all-btn"> View More Free Services</button>
                    </div>
            </div>
        </section>
    );
